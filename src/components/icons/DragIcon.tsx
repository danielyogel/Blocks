...
export function DragIcon({}: Params) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' viewBox='0 0 10 16' version='1.1' className='h-full'>
      <title>drag_indicator</title>
      <desc>Created with Sketch.</desc>
      <g stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='Two-Tone' transform='translate(-821.000000, -510.000000)'>
          <g id='Action' transform='translate(100.000000, 100.000000)'>
            <g id='Two-Tone-/-Action-/-drag_indicator' transform='translate(714.000000, 406.000000)'>
              <g>
